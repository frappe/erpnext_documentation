...
<img alt="Berechtigungen für Lesen, Schreiben, Erstellen, Übertragen und Abändern mit Hilfe des Rollenberechtigungen-Managers einstellen" class="screenshot" src="{{docs_base_url}}/v13/assets/img/users-and-permissions/setting-up-permissions-leave-application.png">
...
> Einstellungen > Berechtigungen > [Benutzerrechte-Manager](/docs/v13/user/manual/de/setting-up/users-and-permissions/user-permissions.html)
...
<img class="screenshot" alt="Der Urlaubsantrag sollte von einem Mitarbeiter erstellt werden, und von einem Urlaubsgenehmiger oder Mitarbeiter des Personalwesens genehmigt werden." src="{{docs_base_url}}/v13/assets/img/users-and-permissions/setting-up-permissions-leave-application-form.png">
...
<img class="screenshot" alt="Einem Mitarbeiter Lese-, Schreib- und Erstellrechte für einen Urlaubsantrag geben."  src="{{docs_base_url}}/v13/assets/img/users-and-permissions/setting-up-permissions-employee-role.png">
...
<img class="screenshot" alt="Den Zugriff für einen Benutzer mit der Rolle Mitarbeiter auf Urlaubsanträge über den Benutzerberechtigungen-Manager einschränken." src="{{docs_base_url}}/v13/assets/img/users-and-permissions/setting-up-permissions-employee-user-permissions.png">
...
<img class="screenshot" alt="Einem Personalmanager Rechte für Übertragen und Stornieren für Urlaubsanträge geben. 'Benutzerberechtigungen anwenden' ist demarkiert um vollen Zugriff zu ermöglichen." src="{{docs_base_url}}/v13/assets/img/users-and-permissions/setting-up-permissions-hr-manager-role.png">
...
<img class="screenshot" alt="Leserechte auf einen Satz von Feldern auf bestimmte Rollen beschränken." src="/docs/v13/assets/old_images/erpnext/setting-up-permissions-level-1.png">
