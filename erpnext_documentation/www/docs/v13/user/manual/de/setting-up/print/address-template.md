...
Das Programm zum Erstellen von Vorlagen basiert auf HTML und [Jinja Templating](http://jinja.pocoo.org/docs/v13/templates/) und alle Felder (auch die benutzerdefinierten) sind verfügbar um eine Vorlage zu erstellen.
...
<img class="screenshot" alt="Adressvorlage" src="{{docs_base_url}}/v13/assets/img/setup/print/address-format.png">
