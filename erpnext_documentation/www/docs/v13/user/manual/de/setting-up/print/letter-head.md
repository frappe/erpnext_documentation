...
<img class="screenshot" alt="Briefkopf" src="{{docs_base_url}}/v13/assets/img/setup/print/letter-head.png">

So sieht der Briefkopf eines Ausdruckes aus:

<img class="screenshot" alt="Briefkopf" src="{{docs_base_url}}/v13/assets/img/setup/print/letter-head-1.png">
