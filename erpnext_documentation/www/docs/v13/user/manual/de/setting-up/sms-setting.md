...
<img class="screenshot" alt="SMS-Einstellungen" src="{{docs_base_url}}/v13/assets/img/setup/sms-settings2.jpg">
...
<img class="screenshot" alt="SMS-Einstellungen" src="{{docs_base_url}}/v13/assets/img/setup/sms-settings1.png">
