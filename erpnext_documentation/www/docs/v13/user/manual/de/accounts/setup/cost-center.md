...
<img class="screenshot" alt="Kostenstellenplan" src="{{docs_base_url}}/v13/assets/img/accounts/budgeting-cost-center.png">
...
![Budgetverteilung](/docs/v13/assets/old_images/erpnext/budgeting.png)
