...
2. Erstellen Sie einen Datensatz für die [POS-Einstellungen](/docs/v13/user/manual/de/setting-up/pos-setting.html)
...
![POS](/docs/v13/assets/old_images/erpnext/pos-add-item.png)
...
![POS](/docs/v13/assets/old_images/erpnext/pos-remove-item.png)
...
![POS-Zahlung](/docs/v13/assets/old_images/erpnext/pos-make-payment.png)
