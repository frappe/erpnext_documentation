...
<img class="screenshot" alt="Währung über den Kontenplan einstellen"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/chart-of-accounts.png">
...
<img class="screenshot" alt="Kontenwährung anpassen"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/account.png">
...
<img class="screenshot" alt="Währung des Kundenkontos"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/customer.png">
...
<img class="screenshot" alt="Offene Ausgangsrechnung"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/sales-invoice.png">
...
<img class="screenshot" alt="Wechselkurs im Buchungssatz"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/journal-entry-multi-currency.png">
...
<img class="screenshot" alt="Buchungssatz mit verschiedenen Währungen"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/journal-entry-row.png">
...
<img class="screenshot" alt="Zahlungsbuchung"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/payment-entry.png">
...
<img class="screenshot" alt="Übertrag zwischen den Banken"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/bank-transfer.png">
...
<img class="screenshot" alt="Bericht zum Hauptbuch"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/general-ledger.png">
...
<img class="screenshot" alt="Bericht zu den Forderungen"  	src="{{docs_base_url}}/v13/assets/img/accounts/multi-currency/accounts-receivable.png">
