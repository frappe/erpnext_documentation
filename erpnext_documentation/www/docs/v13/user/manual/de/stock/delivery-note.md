...
<img class="screenshot" alt="Lieferschein" src="{{docs_base_url}}/v13/assets/img/stock/delivery-note.png">
...
Wenn Sie Artikel, die ein [Produkt-Bundle](/docs/v13/user/manual/de/selling/setup/product-bundle.html), ERPNext will automatically beinhalten, versenden, erstellt Ihnen ERPNext automatisch eine Tabelle "Packliste" basierend auf den Unterartikeln dieses Artikels.
