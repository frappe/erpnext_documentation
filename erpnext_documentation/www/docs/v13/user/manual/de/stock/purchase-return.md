...
<img class="screenshot" alt="Original-Eingangsrechnung" src="{{docs_base_url}}/v13/assets/img/stock/purchase-return-original-purchase-receipt.png">
...
<img class="screenshot" alt="Reklamation zum Lieferschein" src="{{docs_base_url}}/v13/assets/img/stock/purchase-return-against-purchase-receipt.png">
...
<img class="screenshot" alt="Reklamation und Lagerbuch" src="{{docs_base_url}}/v13/assets/img/stock/purchase-return-stock-ledger.png">
...
<img class="screenshot" alt="Reklamation und Lagerbuch" src="{{docs_base_url}}/v13/assets/img/stock/purchase-return-general-ledger.png">
