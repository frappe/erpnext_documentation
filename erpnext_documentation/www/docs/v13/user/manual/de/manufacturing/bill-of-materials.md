...
<img class="screenshot" alt="Task" src="{{docs_base_url}}/v13/assets/img/manufacturing/bom.png">
...
<img class="screenshot" alt="Kostenkalkulation" src="{{docs_base_url}}/v13/assets/img/manufacturing/bom-costing.png">

* Diese Kosten können über die Schaltfläche "Kosten aktualisieren" aktualisiert werden.

<img class="screenshot" alt="Kosten aktualisieren" src="{{docs_base_url}}/v13/assets/img/manufacturing/bom-update-cost.png">
...
<img class="screenshot" alt="Aufgelöste Ansicht" src="{{docs_base_url}}/v13/assets/img/manufacturing/bom-exploded.png">
