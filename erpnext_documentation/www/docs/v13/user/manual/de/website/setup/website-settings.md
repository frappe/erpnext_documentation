...
<img class="screenshot" alt="Webseiten-Einstellungen" src="{{docs_base_url}}/v13/assets/img/website/website-settings.png">

### Zielseite

* Homepage: Sie können angeben, welche [Webseite](/docs/v13/user/manual/de/website/web-page.html) die Startseite der Homepage ist.
...
<img class="screenshot" alt="Webseiten-Themen" src="{{docs_base_url}}/v13/assets/img/website/website-theme.png">
...
<img class="screenshot" alt="Banner" src="{{docs_base_url}}/v13/assets/img/website/banner.png">

### Kopfleiste

Hier können Sie die Menüeinträge in der Kopfleiste einstellen.

<img class="screenshot" alt="Kopfleiste" src="{{docs_base_url}}/v13/assets/img/website/top-bar.png">
...
<img class="screenshot" alt="Einbindungen" src="{{docs_base_url}}/v13/assets/img/website/integrations.png">
