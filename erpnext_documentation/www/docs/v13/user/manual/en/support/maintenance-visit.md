...
![SO Maintenance Visit](/docs/v13/assets/img/support/so-maintenance-visit.png)
...
1. Save.
    ...
    <img class="screenshot" alt="Maintenance Visit" src="{{docs_base_url}}/v13/assets/img/support/maintenance-visit.png">
