...
![Discount on Price List Rate](/docs/v13/assets/img/selling/discount-on-price-list-rate.png)
...
![Additional Discount](/docs/v13/assets/img/selling/additional-discount.png)
...
![Discount on Net Total](/docs/v13/assets/img/selling/discount-on-net-total.png)
...
![Discount on Grand Total](/docs/v13/assets/img/selling/discount-on-grand-total.png)
