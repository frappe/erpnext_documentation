...
4. Save.
<img class="screenshot" alt="Product Bundle" src="{{docs_base_url}}/v13/assets/img/selling/product-bundle.png">
...
<img class="screenshot" alt="Product Bundle" src="{{docs_base_url}}/v13/assets/img/selling/product-bundle.gif">
