...
You can also set a [Web Page](/docs/v13/user/manual/en/website/web-page) as the
landing page.

If you want to use the ERPNext [Homepage](/docs/v13/user/manual/en/website/homepage),
you must set it as `home`.

![Website Settings - Landing Page](/docs/v13/assets/img/website/website-settings-landing-page.png)
...
configuring Website Theme [here](/docs/v13/user/manual/en/website/website-theme).
...
![Website Settings - Banner Image](/docs/v13/assets/img/website/website-settings-banner-image.png)
...
![Website Settings - Favicon](/docs/v13/assets/img/website/website-settings-favicon.png)
*Website Settings - Favicon*

View your website by clicking on **View Website** in the action bar on top right.

![Website with Brand and Favicon](/docs/v13/assets/img/website/website-brand-and-favicon.png)
...
![Website Setting - Top Bar](/docs/v13/assets/img/website/website-settings-top-bar.png)
*Website Setting - Top Bar*

![Website Navbar Items](/docs/v13/assets/img/website/website-navbar-items.png)
...
![Website Settings - Banner](/docs/v13/assets/img/website/website-settings-banner.png)
*Website Settings - Banner*

![Website Banner](/docs/v13/assets/img/website/website-banner.png)
*Website Banner*
...
![Website Settings - Footer Address](/docs/v13/assets/img/website/website-settings-footer-address.png)
*Website Settings - Footer Address*

![Website Settings - Footer Links](/docs/v13/assets/img/website/website-settings-footer-links.png)
*Website Settings - Footer Links*

![Website Footer](/docs/v13/assets/img/website/website-footer.png)
*Website Footer*
...
![Google Integrations](/docs/v13/assets/img/website/website-settings-integrations.png)
*Google Integrations*
...
![Website Settings - Header](/docs/v13/assets/img/website/website-settings-header.png)
...
![Website Settings - Robots](/docs/v13/assets/img/website/website-settings-robots-txt.png)
...
![Website Settings - Routes Redirects](/docs/v13/assets/img/website/website-settings-route-redirects.png)
