...
<img class="screenshot" alt="Sales Invoice" src="{{docs_base_url}}/v13/assets/img/project/projects-sales-invoice-from-timesheet.png">
...
<img class="screenshot"alt="Sales Invoice" src="{{docs_base_url}}/v13/assets/img/project/timesheet/timesheet-billing-to-sales-invoice.gif">
