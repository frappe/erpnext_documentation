...
7. Save
    ...
    <img class="screenshot" alt="Email Campaign" src="{{docs_base_url}}/v13/assets/img/crm/email-campaign.png">
...
2. Click on + in front of Email Campaigns to create a new Email Campaign for the Campaign.
    ...
    <img class="screenshot" alt="Email Campaigns from Dashboard" src="{{docs_base_url}}/v13/assets/img/crm/email-campaigns-from-dash.png">
...
<img class="screenshot" alt="Linked Communication" src="{{docs_base_url}}/v13/assets/img/crm/email-campaign-linked-comm.png">
...
<img class="screenshot" alt="Unsubscribe link" src="{{docs_base_url}}/v13/assets/img/crm/unsubscribe-link.png">

When the lead or contact unsubscribes, the status of the Email Campaign document changes to 'Unsubscribed'.

<img class="screenshot" alt="Unsubscribed" src="{{docs_base_url}}/v13/assets/img/crm/email-campaign-unsubscribed.png">
...
- **Unsubscribed**: When the Lead or Contact unsubscribes from the Campaign.
    ...
    <img class="screenshot" alt="Email Campaign Status" src="{{docs_base_url}}/v13/assets/img/crm/email-campaign-status.png">
