...
<img class="screenshot" alt="Customer Group Tree" src="{{docs_base_url}}/v13/assets/img/crm/customer-group-tree.png">
...
<img class="screenshot" alt="Customer Group report" src="{{docs_base_url}}/v13/assets/img/crm/sales-analytics-customer.gif">
