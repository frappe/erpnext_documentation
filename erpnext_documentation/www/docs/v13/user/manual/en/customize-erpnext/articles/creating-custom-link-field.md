...
<img alt="Select Docytpe" class="screenshot" src="{{docs_base_url}}/v13/assets/img/customize/customize-custom-link-field.gif">
...
<img alt="Enter Values" class="screenshot" src="{{docs_base_url}}/v13/assets/img/customize/customize-creating-custom-link-fields.png">
