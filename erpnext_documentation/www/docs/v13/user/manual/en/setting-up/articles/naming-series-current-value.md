...
<img alt="Update Series Section" class="screenshot" src="{{docs_base_url}}/v13/assets/img/articles/current-no-1.png">

#### Select Prefix

Considering our scenario, prefix for Sales Order will be "SO".

<img alt="Series Prefix" class="screenshot" src="{{docs_base_url}}/v13/assets/img/articles/current-no-2.png">
...
<img alt="Series Current Value" class="screenshot" src="{{docs_base_url}}/v13/assets/img/articles/current-no-3.png">
