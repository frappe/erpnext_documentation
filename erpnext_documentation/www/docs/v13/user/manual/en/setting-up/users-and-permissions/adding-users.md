...
1. Save.
    ...
    <img class="screenshot" src="{{docs_base_url}}/v13/assets/img/users-and-permissions/add-user-details.png" alt="Add User Details">
...
<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/setup/users/user-2.png" alt="User Roles">
...
<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/setup/users/user-3.png" alt="User Block Module">
...
<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/setup/users/module-profile.png" alt="Module Profile">
...
![User dashboard buttons](/docs/v13/assets/img/setup/users/user-after-save.png)
...
<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/setup/users/user-login-email.png" alt="Email Login">

Login with Email or Mobile:

<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/setup/users/user-login-mobile.png" alt="Mobile No Login">
