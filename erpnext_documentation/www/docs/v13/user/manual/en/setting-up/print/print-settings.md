...
<img class="screenshot" alt="Print Settings" src="{{docs_base_url}}/v13/assets/img/setup/print/print-settings.png">
...
![Incompact Print Format Settings](/docs/v13/assets/img/setup/print/incompact-print.png)

This is what the Compact Print Format looks like:
![Compact Print Format Settings](/docs/v13/assets/img/setup/print/compact-print.png)
