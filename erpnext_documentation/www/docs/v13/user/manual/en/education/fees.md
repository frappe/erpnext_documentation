...
1. Save.
    ...
    ![Fees](/docs/v13/assets/img/education/education-fee-1.gif)
...
![Fees](/docs/v13/assets/img/education/education-fees-2.png)
...
![Fees](/docs/v13/assets/img/education/education-fee-4.gif)

### 3.3. Fee Components

You can also add the **Fee Components** by selecting and adding the **Fee Category**, **Description** and **Fee Amount**.

![Fees](/docs/v13/assets/img/education/education-fees-5.png)
...
* **Cost Center**: Select and add the name of the Cost Center of your Institute for Accounting Dimensions.
    ...
    ![Fees](/docs/v13/assets/img/education/education-fees-3.png)

### Payment
Directly make a payment from fee, select Mode of Payment in payment entry and submit the payment.

<img class="screenshot" alt="Fee Payment" src="{{docs_base_url}}/v13/assets/img/education/fees/fee-payment.png">
