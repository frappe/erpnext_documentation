...
<img alt="Debit Credit Not Equal" class="screenshot" src="{{docs_base_url}}/v13/assets/img/articles/difference-entry-1.png">
...
<img alt="Debit Credit Not Equal" class="screenshot" src="{{docs_base_url}}/v13/assets/img/articles/difference-entry-2.gif">
