...
1. Users can also apply the discount on the other Item Code / Item Group / Brand by selecting the value for Apply Rule On Other field.
 ...
 ![Promotional Scheme](/docs/v13/assets/img/accounts/promotional-schemes.png)
1. Save.
...
![Promotional Scheme Price Discount](/docs/v13/assets/img/accounts/promotional-schemes-price-discount.png)
...
![Promotional Scheme Product Discount](/docs/v13/assets/img/accounts/promotional-schemes-product-discount.png)
...
![Promotional Scheme Mixed Condition](/docs/v13/assets/img/accounts/promotional-schemes-mixed-conditions.png)
...
![Promotional Scheme Discount on Other Item](/docs/v13/assets/img/accounts/promotional-schemes-discount-on-other.png)
