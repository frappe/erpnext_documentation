...
3. Set the General Ledger filters for the statements which will be sent to the customers.
    ...
    <img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-name_and_filters.png">
...
4. In the "Customers" section, you have an option to select customers in the child table and fetch their primary and billing emails.
    ...
    <img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-customers.png"><br>
...
5. In "Print Preferences" section you can select 2 things:
    ...
    <img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-print.png">

6. The "Email Settings" section lets you configure how you want the emails to be sent. There are two subsections in this:

    <img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-auto-email.png">
    ...
    <img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-email-default-content.png">
...
<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-buttons.png">
...
<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-template.png">

Resulting Email:

<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-email.png">

Report PDF:

<img class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/psoa-report.png">
