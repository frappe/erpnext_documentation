...
<img class="screenshot" alt="Item - Deferred Revenue" src="{{docs_base_url}}/v13/assets/img/accounts/deferred-item-expense.png">
...
<img class="screenshot" alt="Item - Deferred Revenue" src="{{docs_base_url}}/v13/assets/img/accounts/deferred-purchase-invoice.gif">
