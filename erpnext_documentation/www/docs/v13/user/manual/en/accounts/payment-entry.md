...
![Payment Entry from SO]({{docs_base_url}}/v13/assets/img/accounts/payment-entry-so.png)
...
1. Save and Submit.
 ![Payment Entry from SO]({{docs_base_url}}/v13/assets/img/accounts/payment-entry-so.gif)
...
![Payment Party]({{docs_base_url}}/v13/assets/img/accounts/payment-party.png)
...
![Outstanding Invoice]({{docs_base_url}}/v13/assets/img/accounts/outstanding-pe.png)
...
![Outstanding Invoice]({{docs_base_url}}/v13/assets/img/accounts/pe-get-outstanding.gif)

The loss/deductions can be written off:
![Payment Deductions]({{docs_base_url}}/v13/assets/img/accounts/payment-deductions.png)
...
<img class="screenshot" alt="Making Payment" src="{{docs_base_url}}/v13/assets/img/accounts/payment-entry-5.gif">
...
![Payment Write Off]({{docs_base_url}}/v13/assets/img/accounts/payment-write-off-1.png)

In this table, the deductions or loss from payments can be adjusted as explained in the example in the previous section.

![Payment Write Off]({{docs_base_url}}/v13/assets/img/accounts/payment-write-off.png)

### 3.5 After Submitting
Save and Submit Payment Entry. On submission, outstanding will be updated in the Invoices.

<img class="screenshot" alt="Making Payment" src="{{docs_base_url}}/v13/assets/img/accounts/payment-entry-8.png">
...
![Foreign Account in Customer]({{docs_base_url}}/v13/assets/img/accounts/cust-foreign-acc.png)
...
<img class="screenshot" alt="Making Payment" src="{{docs_base_url}}/v13/assets/img/accounts/payment-entry-6.png">
...
<img class="screenshot" alt="Making Payment" src="{{docs_base_url}}/v13/assets/img/accounts/payment-entry-7.png">
...
<img class="screenshot" alt="Making Payment" src="{{docs_base_url}}/v13/assets/img/accounts/payment-entry-9.png">
...
2. Make the payment. On submitting a document against which Journal Entry can be made, you will find the Payment under the **Create** button.
 ...
 <img class="screenshot" alt="Making Payment" src="{{docs_base_url}}/v13/assets/img/accounts/payment-entry-1.png">

3. Journal Entry. Save and submit the journal entry to record the payment against the invoice
 <img class="screenshot" alt="Making Payment" src="{{docs_base_url}}/v13/assets/img/accounts/journal-entry.png">
