...
<img alt="Debit Credit Not Equal" class="screenshot" src="{{docs_base_url}}/v13/assets/img/articles/fiscal-year-error-1.png">
...
<img alt="Debit Credit Not Equal" class="screenshot" src="{{docs_base_url}}/v13/assets/img/articles/fiscal-year-error-2.png">
