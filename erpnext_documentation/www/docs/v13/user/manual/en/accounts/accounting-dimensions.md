...
<img alt="Create custom dimension" class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/accounting-dimension.png">
...
<img alt="Create custom dimension" class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/dimension-section.png">

<img alt="Create custom dimension" class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/dimension-transaction.png">
...
<img alt="Create custom dimension" class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/report-dimensions.png">
...
<img alt="Create custom dimension" class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/dimension-mandatory.png">
...
<img alt="Create custom dimension" class="screenshot" src="{{docs_base_url}}/v13/assets/img/accounts/dimension-disable.png">
