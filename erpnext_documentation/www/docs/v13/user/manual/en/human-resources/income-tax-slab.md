...
<img class="screenshot" alt="Income Tax Slab" src="/docs/v13/assets/img/human-resources/income-tax-slab.png">
...
<img class="screenshot" alt="Other Charged on Income Tax" src="/docs/v13/assets/img/human-resources/other-taxes-on-income-tax.png">
