...
1. Enter Repayment Start Date.
  ...
  <img class="screenshot" alt="Loan" src="{{docs_base_url}}/v13/assets/img/human-resources/loan1.png">
...
1. Save. Once saved, a Repayment Schedule is automatically generated. The first repayment payment date would be set as per the "Repayment Start Date". The
  ...
  <img class="screenshot" alt="Repayment Schedule" src="{{docs_base_url}}/v13/assets/img/human-resources/loan2.png">
...
<img class="screenshot" alt="Disbursement Entry" src="{{docs_base_url}}/v13/assets/img/human-resources/disbursement-entry.png">
...
<img class="screenshot" alt="Salary Slip" src="{{docs_base_url}}/v13/assets/img/human-resources/loan-repayment-salary-slip.png">
