...
3. Save.
 ...
 <img class="screenshot" alt="Salary Component" src="{{docs_base_url}}/v13/assets/img/human-resources/salary-component1.png">
...
<img class="screenshot" alt="Salary Component" src="{{docs_base_url}}/v13/assets/img/human-resources/salary-component2.png">
...
<img class="screenshot" alt="Flexible Benefit" src="{{docs_base_url}}/v13/assets/img/human-resources/flexible-ben.png">
...
* **Pay Against Benefit Claim:** Enable this checkbox if you want to pay this benefit via the [Employee Benefit Claim](/docs/v13/user/manual/en/human-resources/employee-benefit-claim).
