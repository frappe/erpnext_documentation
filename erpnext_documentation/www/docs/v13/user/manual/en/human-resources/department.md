...
<img class="screenshot" alt="Department Tree" src="{{docs_base_url}}/v13/assets/img/human-resources/department-tree.png">
...
1. Save.
    ...
    <img class="screenshot" alt="Department" src="{{docs_base_url}}/v13/assets/img/human-resources/department.png">
...
<img class="screenshot" alt="Leave and Expense Approver" src="{{docs_base_url}}/v13/assets/img/human-resources/leave-and-expense.png">
