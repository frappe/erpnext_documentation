...
1. Save and Submit.
    ...
    <img class="screenshot" alt="Attendance" src="{{docs_base_url}}/v13/assets/img/human-resources/attendance.png">
...
1. Click on the **Mark Attendance** button and click on **Yes**.
    ...
    <img class="screenshot" alt="Attendance" src="{{docs_base_url}}/v13/assets/img/human-resources/marking_unmarked_attendance.gif">
