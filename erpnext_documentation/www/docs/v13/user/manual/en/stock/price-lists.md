...
ERPNext lets you maintain multiple Selling and Buying [Item Prices](/docs/v13/user/manual/en/stock/item-price) using Price Lists.
...
* Price Lists will be used when creating an [Item Prices](/docs/v13/user/manual/en/stock/item-price) to track selling or buying price of an item.
