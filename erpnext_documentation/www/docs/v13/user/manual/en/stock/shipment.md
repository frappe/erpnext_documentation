...
1. Go to the Shipment list, click on New.
 ...
 <img class="screenshot" alt="Unsaved Shipment" src="{{docs_base_url}}/v13/assets/img/stock/unsaved-shipment.png">
...
1. Save and Submit.
 ...
 <img class="screenshot" alt="Submitted Shipment" src="{{docs_base_url}}/v13/assets/img/stock/shipment-submitted.png">
...
1. Click on **Create** > **Shipment** in the Delivery Note.
 ...
 <img class="screenshot" alt="Submitted Shipment" src="{{docs_base_url}}/v13/assets/img/stock/shipment-from-delivery-note.png">
...
To automatically fetch frequently used parcel dimensions, a Parcel Template can be created and set in the **Parcel Template** field. After adding the template, click on the **Add template** button.
 ...
 <img class="screenshot" alt="Submitted Shipment" src="{{docs_base_url}}/v13/assets/img/stock/shipment-parcel.png">
