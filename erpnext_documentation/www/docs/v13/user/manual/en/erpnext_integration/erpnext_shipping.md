...
<img class="screenshot" alt="Packlink API" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/packlink_api.png">
...
<img class="screenshot" alt="Sendcloud API" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/sendcloud_api.png">
...
<img class="screenshot" alt="LetMeShip API" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/letmeship_api.png">

## 2. Features

### 2.1 Comparison of Shipping Rates

Once a [Shipment](/docs/v13/user/manual/en/stock/shipment) is submitted, if the app is installed, the button **Fetch Shipping Rates** will appear. On clicking, you will get a list of services along with their service providers and rates.

<img class="screenshot" alt="Fetch Rates" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/fetch_rates.png">
...
1. Assuming the highlighted service is our frequently used service, let us add it to our **Preferred Services**
 ...
 <img class="screenshot" alt="Highlight Service" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/service_highlight.png">
...
<img class="screenshot" alt="Preferred Service" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/preferred_service.png">
...
<img class="screenshot" alt="Shipment Creation" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/create_shipment.gif">

You can also search for your transaction on your service provider's platform using the **Shipment ID** field.

<img class="screenshot" alt="Packlink Shipment" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/packlink_shipment.png">

### 2.3 Printing Labels

To avail the **Print Shipping Label** button, the **Shipment ID** must be generated in the current record.

<img class="screenshot" alt="Print Label Button" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/print_label_button.png">

You can then click on it and generate your shipping label.

<img class="screenshot" alt="Dummy Shipping Label" src="{{docs_base_url}}/v13/assets/img/erpnext_integrations/dummy_shipping_label.png">
