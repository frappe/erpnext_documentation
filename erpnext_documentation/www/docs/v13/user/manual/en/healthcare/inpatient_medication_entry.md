...
4. There are various filters available to fetch the pending Inpatient Medication Orders:
    ...
    <img class="screenshot" alt="Inpatient Medication Entry filters" src="{{docs_base_url}}/v13/assets/img/healthcare/ime-filters.png">
...
6. Optionally, check/uncheck _Update Stock_. If checked, specify the Warehouse from where drugs should be consumed.
    ...
    <img class="screenshot" alt="Update Stock" src="{{docs_base_url}}/v13/assets/img/healthcare/ime-stock.png">
...
<img class="screenshot" alt="Completed Inpatient Medication Order Entry" src="{{docs_base_url}}/v13/assets/img/healthcare/imoe-completed.png">
...
<img class="screenshot" alt="Stock Entry" src="{{docs_base_url}}/v13/assets/img/healthcare/ime-stock-entry.png">

<img class="screenshot" alt="Stock Entry Detail" src="{{docs_base_url}}/v13/assets/img/healthcare/ime-stock-entry-detail.png">
...
<img class="screenshot" alt="Drug Shortage Dialog" src="{{docs_base_url}}/v13/assets/img/healthcare/drug-shortage-dialog.gif">
...
<img class="screenshot" alt="Make Stock Entry for Drug Shortage" src="{{docs_base_url}}/v13/assets/img/healthcare/make-stock-entry.gif">
