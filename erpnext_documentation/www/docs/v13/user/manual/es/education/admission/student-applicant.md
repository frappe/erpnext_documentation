...
<img class="screenshot" alt="Student Applicant" src="{{docs_base_url}}/v13/assets/img/education/admission/student-applicant.png">
...
el sistema creará un estudiante usando esa aplicación y le va a redireccionar a el [Formulario de Inscripción al Programa](/docs/v13/user/manual/es/education/admission/program-enrollment).

<img class="screenshot" alt="Student Applicant Enrollment" src="{{docs_base_url}}/v13/assets/img/education/admission/student-applicant-enroll.png">
