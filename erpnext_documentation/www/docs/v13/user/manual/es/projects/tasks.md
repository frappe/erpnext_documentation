...
<img class="screenshot" alt="Task" src="{{docs_base_url}}/v13/assets/img/project/task.png">

### Estado de una Tarea

Una tarea puede tener uno de los siguientes estados - Abierto, Trabajando, Pendiente de Revisión, Cerrado, o Cancelado.

<img class="screenshot" alt="Task - Status" src="{{docs_base_url}}/v13/assets/img/project/task_status.png">
...
<img class="screenshot" alt="Depends On" src="{{docs_base_url}}/v13/assets/img/project/task_depends_on.png">
...
ERPNext usa [Time Log](/docs/v13/user/manual/es/projects/time-log-batch) para seguir el progreso de una tarea.
...
<img class="screenshot" alt="Task - View Time Log" src="{{docs_base_url}}/v13/assets/img/project/task_view_time_log.png">

<img class="screenshot" alt="Task - Time Log List" src="{{docs_base_url}}/v13/assets/img/project/task_time_log_list.png">

* Puedes también crear un Registro de Tiempo directamente y luego asociarlo a una Tarea.

<img class="screenshot" alt="Task - Link Time Log" src="{{docs_base_url}}/v13/assets/img/project/task_time_log_link.png">
...
<img class="screenshot" alt="Task - View Expense Claim" src="{{docs_base_url}}/v13/assets/img/project/task_view_expense_claim.png">

* También puede crear un Reclamo de gastos directamente y vincularlo al Proyecto.

<img class="screenshot" alt="Task - Link Expense Claim" src="{{docs_base_url}}/v13/assets/img/project/task_expense_claim_link.png">
...
<img class="screenshot" alt="Task - Total Expense Claim" src="{{docs_base_url}}/v13/assets/img/project/task_total_expense_claim.png">
