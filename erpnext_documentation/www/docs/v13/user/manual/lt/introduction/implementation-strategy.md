...
Jei jau esate susipažinę su ERPNext, pradėkite vesti tikrus duomenis!
  ...
  * Taip pat galite sukurti naują paskyrą adresu [https://erpnext.com](https://erpnext.com) ir 30 dienų nemokamai naudoti bandomąją versiją. [Sužinokite daugiau ERPNext diegimo būdų](/docs/v13/user/manual/lt/introduction/getting-started-with-erpnext)
