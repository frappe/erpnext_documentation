...
The Inpatient Medication Orders Report shows all the data related to the medication orders for inpatients. This report is based on the [Inpatient Medication Order](/docs/v12/user/manual/en/healthcare/inpatient_medication_order) Document Type.
