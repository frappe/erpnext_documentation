...
Issues are automatically created if you use the **append to feature** in [Email Account](/docs/v12/user/manual/en/setting-up/email/email-account#32-incoming-email-accounts).
...
* **Customer**: If the email was sent from a [Customer](/docs/v12/user/manual/en/CRM/customer) stored in your ERPNext account, then a Customer link will appear in this field.
...
User can select the [Service Level Agreement](/docs/v12/user/manual/en/support/service-level-agreement) (SLA) from the list.
...
> Issues can be assigned automatically among Users using [Assignment Rule](/docs/v12/user/manual/en/automation/assignment-rule).
