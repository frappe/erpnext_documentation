...
On submission of the Employee Onboarding, a [Project](/docs/v12/user/manual/en/projects/project) will be created. Within the Project, [Tasks](/docs/v12/user/manual/en/projects/tasks) will also be created for each Activity.
