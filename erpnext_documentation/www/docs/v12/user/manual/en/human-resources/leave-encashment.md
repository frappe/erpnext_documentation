...
1. [Employee](/docs/v12/user/manual/en/human-resources/leave-allocation)
...
1. Save and Submit.
	...
	src="{{docs_base_url}}/v12/assets/img/human-resources/leave-encashment-new.png">
...
On submitting a Leave Encashment for an Employee, ERPNext automatically creates an [Additional Salary](/docs/v12/user/manual/en/human-resources/additional-salary) which will get added to the Salary Slip of the Employee when processing the payroll.
