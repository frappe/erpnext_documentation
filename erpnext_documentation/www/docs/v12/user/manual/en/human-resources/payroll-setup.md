...
1. Define [Payroll Period](/docs/v12/user/manual/en/human-resources/payroll-period.html) (optional)
1. Define [Income Tax Slab](/docs/v12/user/manual/en/human-resources/income-tax-slab.html) (optional)
...
4. Generate Salary Slips via [Payroll Entry](/docs/v12/user/manual/en/human-resources/payroll-entry.html).
5. Book the Salary in your Accounts.

## Payroll Period
[Payroll Period](/docs/v12/user/manual/en/human-resources/payroll-period.html), in ERPNext, is a period for which Employees get paid for their occupation with the Company. Payroll period helps you define Tax slabs applicable for the period, making it easier to manage changing laws.
