...
<img class="screenshot" alt="Assign" src="/docs/v12/assets/img/automation/milestone-in-timeline.png">
...
1. [Tracking Versions](/docs/v12/user/manual/en/using-erpnext/document-versioning)
1. [Dashboards](/docs/v12/user/manual/en/using-erpnext/dashboard)
