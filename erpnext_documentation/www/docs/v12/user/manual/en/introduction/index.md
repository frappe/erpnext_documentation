...
- **Completeness**: All necessary modules are available. [View full list](https://erpnext.com/docs/v12/user/manual/en "ERPNext User Manual").
...
1. [Do I Need an ERP?](/docs/v12/user/manual/en/introduction/do-i-need-an-erp)
- [Open Source](/docs/v12/user/manual/en/introduction/open-source)
- [Getting Started with ERPNext](/docs/v12/user/manual/en/introduction/getting-started-with-erpnext)
- [The Champion](/docs/v12/user/manual/en/introduction/the-champion)
- [Implementation Strategy](/docs/v12/user/manual/en/introduction/implementation-strategy)
- [Key Workflows](/docs/v12/user/manual/en/introduction/key-workflows)
- [Concepts and Terms](/docs/v12/user/manual/en/introduction/concepts-and-terms)
