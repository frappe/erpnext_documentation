...
Using permissions, you can limit user access to document types. The limitation can be based on fields like Company, Territory, Branch, etc. To know more about User Permissions, [click here](/docs/v12/user/manual/en/setting-up/users-and-permissions/user-permissions).
...
* **Allow Login using User Name**: Allow user login via their username set in the [User master](/docs/v12/user/manual/en/setting-up/users-and-permissions/adding-users).
...
* **Hide footer in auto-email reports**: If ticked, footers will be hidden in [Auto Email reports](/docs/v12/user/manual/en/setting-up/email/auto-email-reports).
