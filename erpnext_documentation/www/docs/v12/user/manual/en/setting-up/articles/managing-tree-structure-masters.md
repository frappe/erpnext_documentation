...
<img alt="Default Territories" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/territory-2.png">
...
<img alt="Default Territories" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/territory-1.gif">

Following is how Child Territories will be listed under a Parent Territory.

<img alt="Adding new Territories" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/territory-3.png">
