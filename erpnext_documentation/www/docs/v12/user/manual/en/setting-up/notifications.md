...
2. Define what events you want to watch under Send Alert On. Events are:
    ...
    1. Custom: Send a notification to an [Email Account](/docs/v12/user/manual/en/setting-up/email/email-account) selected.
...
In order to use this channel, you would need to complete the configuration of [SMS Settings](/docs/v12/user/manual/en/setting-up/sms-setting).
