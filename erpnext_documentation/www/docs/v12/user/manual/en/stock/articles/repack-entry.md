...
<img alt="Repack Entry" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/repack-1.png">
...
<img alt="Repack Stock Entry" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/repack-2.png">
