...
* **To Bill**: Yet to be billed using a [Sales Invoice](/docs/v12/user/manual/en/accounts/sales-invoice).
...
[Contacts](/docs/v12/user/manual/en/CRM/contact) and [Addresses](/docs/v12/user/manual/en/CRM/address) are stored separately so that you can attach multiple Contacts or Addresses to the customer.
...
* **Discount and Margin**: You can apply a discount on individual Items percentage-wise or the total amount of the Item. Read [Applying Discount](/docs/v12/user/manual/en/selling/articles/applying-discount) for more details.
...
* **Batch No and Serial No**: If your Item is serialized or batched, you will have to enter [Serial Number](/docs/v12/user/manual/en/stock/serial-no) and [Batch](/docs/v12/user/manual/en/stock/batch) in the Items table. You are allowed to enter multiple Serial Numbers in one row (each on a separate line) and you must enter the same number of Serial Numbers as the quantity.
    ...
    The 'Available Qty at From Warehouse', 'Available Batch Qty at From Warehouse', and 'Installed Qty' will be shown. To know more about installation, visit the [Installation Note](/docs/v12/user/manual/en/stock/installation-note) page.
...
After enabling Inspection Criteria in the [Item form](/docs/v12/user/manual/en/stock/item#216-inspection-criteria) for Sales and attaching a Quality Inspection Template there, Quality Inspections can be recorded in Delivery Notes.

### 3.7 Taxes and Charges
The Taxes and Charges will be fetched from the [Sales Order](/docs/v12/user/manual/en/buying/purchase-order).

Visit the [Sales Taxes and Charges Template](/docs/v12/user/manual/en/selling/sales-taxes-and-charges-template) page to know more about taxes.
...
* [Project](/docs/v12/user/manual/en/projects/project)
* [Campaign](/docs/v12/user/manual/en/CRM/campaign)
* [Source](/docs/v12/user/manual/en/CRM/lead_source)

### 3.11 Printing Settings

#### Letterhead
You can print your Delivery Note on your company's letterhead. Know more [here](/docs/v12/user/manual/en/setting-up/print/letter-head).
...
If you are shipping Items that have a [Product Bundle](/docs/v12/user/manual/en/selling/product-bundle), ERPNext will automatically create a “Packing List” table for you based on the sub-Items in that Item.
...
Slip to break up your Delivery Note into smaller units. To know more about a Packing Slip, visit [this page](/docs/v12/user/manual/en/stock/packing-slip).
go to:
...
* [Installation Note](/docs/v12/user/manual/en/stock/installation-note)
* [Sales Return](/docs/v12/user/manual/en/stock/sales-return)
* [Delivery Trip](/docs/v12/user/manual/en/stock/delivery-trip)
...
Once you've delivered a Sales Order using a Delivery Note, you can create a return entry in case the [Customer](/docs/v12/user/manual/en/CRM/customer) returns the Item. To know more, visit the [Sales Return](/docs/v12/user/manual/en/stock/sales-return) page.

### 3.19 Skipping Delivery Note

If you don't want to create a Delivery Note after a Sales Order and directly want to create a Sales Invoice, enable the feature for it in [Selling Settings](/docs/v12/user/manual/en/selling/selling-settings#32-delivery-note-required).
