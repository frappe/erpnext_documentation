...
* Company and Customer [Address](/docs/v12/user/manual/en/CRM/address) with Postal Code, Email Address and Phone Number set.
* Customer [Contact](/docs/v12/user/manual/en/CRM/contact).
...
You can also automate rate comparison, label generation, tracking, etc. using our [Shipping Integration](/docs/v12/user/manual/en/erpnext_integration/erpnext_shipping).
