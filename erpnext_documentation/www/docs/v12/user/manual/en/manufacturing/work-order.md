...
The **Work Order** can be generated from the [Production Plan](/docs/v12/user/manual/en/manufacturing/production-plan) based on Sales Orders.
...
A Work Order can also be directly created from a [Sales Order](/docs/v12/user/manual/en/selling/sales-order#214-after-submitting).
...
* **Allow Alternative Item**: Sometimes when manufacturing a finished good, specific materials may not be available. For example, using plastic beads instead of plastic crystals. The finished good itself could be different. Ticking this checkbox will allow you the select an Alternative Item. To know more, visit [this page](/docs/v12/user/manual/en/manufacturing/item-alternative).
...
The Source Warehouse can be changed for the raw material items used here. The default Warehouse can be set at the Item level in the [Item](/docs/v12/user/manual/en/stock/item#28-item-defaults) master or globally in [Stock Settings](/docs/v12/user/manual/en/stock/stock-settings#23-default-warehouse).

* **Required Quantity**: This will be calculated automatically based on the [Bill Of Materials](/docs/v12/user/manual/en/manufacturing/bill-of-materials).
...
Materials can be transferred against a Work Order or a Job Card. This is usually fetched from the [Bill Of Materials](/docs/v12/user/manual/en/manufacturing/bill-of-materials), but you can change it in the Work Order also.
...
When a Work Order is created from a [Material Request](/docs/v12/user/manual/en/stock/material-request), it'll be shown here.
...
To know more about Job Cards, visit [this page](/docs/v12/user/manual/en/manufacturing/job-card).
...
1. [Pick List](/docs/v12/user/manual/en/stock/pick-list#22-create-pick-list-from-work-order)
