...
4. Save.
    <img class="screenshot" alt="Contact" src="{{docs_base_url}}/v12/assets/img/crm/address.png">

You can also add an Address from the Customer or Supplier record by clicking on “New Address" button as shown below.

<img class="screenshot" alt="Contact" src="{{docs_base_url}}/v12/assets/img/crm/address-from-supp.png">
...
<img class="screenshot" alt="Contact" src="{{docs_base_url}}/v12/assets/img/crm/link_address_to_multipl_entities.png">
...
<img class="screenshot" alt="Contact" src="{{docs_base_url}}/v12/assets/img/crm/address_title_generation.png">
...
<img class="screenshot" alt="Contact" src="{{docs_base_url}}/v12/assets/img/crm/gstin_in_so.png">
...
<img class="screenshot" alt="Contact" src="{{docs_base_url}}/v12/assets/img/crm/own_company_address.png">
