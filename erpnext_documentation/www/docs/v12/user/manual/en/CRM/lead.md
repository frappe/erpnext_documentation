...
You can add the details of all such people in the same lead. Once you save a Lead, you will get the option to add [Contact](/docs/v12/user/manual/en/CRM/contact) details by clicking on 'New Contact' button. Similarly, you can add the [Address](/docs/v12/user/manual/en/CRM/address) details by clicking on 'New Address'.
...
You can define [Assignment Rules](/docs/v12/user/manual/en/automation/assignment-rule) to automatically assign the leads to sales executives.
...
You can customize the Lead DocType using [Customize Form](/docs/v12/user/manual/en/customize-erpnext/custom-field) tool.
