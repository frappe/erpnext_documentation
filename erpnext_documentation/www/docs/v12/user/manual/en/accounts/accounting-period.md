...
> Note: No role can submit transactions defined in the Accounting Period, even the Role set in 'Role Allowed to Set Frozen Accounts & Edit Frozen Entries' in [Account Settings](/docs/v12/user/manual/en/accounts/accounts-settings).
...
* [Period Closing Voucher](/docs/v12/user/manual/en/accounts/period-closing-voucher)
