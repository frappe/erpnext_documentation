...
A Pricing Rule is somewhat similar to a [Tax Rule](/docs/v12/user/manual/en/accounts/tax-rule).
...
1. Set the discount/price to be applied. To know more, [go to this section](/docs/v12/user/manual/en/accounts/pricing-rule#35-price-discount-scheme).
1. Save.
...
* [Sales Partner](/docs/v12/user/manual/en/selling/sales-partner)
...
Read [adding margin](/docs/v12/user/manual/en/selling/articles/adding-margin) for more details.
...
* **Discount Percentage**: A specific discount percentage can be set. The discount percentage can be set to a specific [Price List](/docs/v12/user/manual/en/stock/price-lists). Leaving the 'For Price List' blank will apply the Pricing Rule to all Price Lists.
