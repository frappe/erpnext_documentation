...
<img alt="Accounts Frozen Date" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/frozen-date-1.png">
...
<img alt="Frozen Date Error" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/frozen-date-2.png">
...
<img alt="Frozen Date Error" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/frozen-date-3.png">
