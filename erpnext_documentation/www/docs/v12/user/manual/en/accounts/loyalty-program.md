...
1. For opting in all Customers by default, tick on 'Auto Opt In (For all customers)'. Otherwise, the program needs to be assigned from the [Customer master](/docs/v12/user/manual/en/accounts/loyalty-program#22-loyalty-points-in-customer).
