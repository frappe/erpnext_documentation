...
<img alt="Sales Invoice Payment Amount" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/withhold-1.png">
...
<img alt="Deduction/Loss Account" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/withhold-2.gif">
