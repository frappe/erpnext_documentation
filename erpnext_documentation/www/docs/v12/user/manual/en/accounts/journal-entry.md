...
* **Accounting Dimensions**: A Project or Cost Center can be linked here to track the costing separately. To know more, [visit this page](/docs/v12/user/manual/en/accounts/accounting-dimensions).
