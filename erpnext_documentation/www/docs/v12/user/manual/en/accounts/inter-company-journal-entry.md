...
* At least two [Companies](/docs/v12/user/manual/en/setting-up/company-setup)
* Setting inter company accounts in [Chart of Accounts](/docs/v12/user/manual/en/accounts/chart-of-accounts)
