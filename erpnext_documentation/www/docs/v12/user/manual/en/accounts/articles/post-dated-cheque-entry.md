...
<img alt="JE Posting Date" class="screenshot" src="{{docs_base_url}}/v12/assets/img/articles/post-dated-1.png">
...
You can adjust Post Dated Payment Entry against an invoice via [Payment Reconciliation Tool](/docs/v12/user/manual/en/accounts/payment-reconciliation).

When cheque is cleared, i.e. on actual date on the cheque, you can update its Clearance Date via [Bank Reconciliation Tool](/docs/v12/user/manual/en/accounts/bank-reconciliation).
