...
<img class="screenshot" alt="Sales Invoice" src="{{docs_base_url}}/v12/assets/img/accounts/sales-invoice.png">
...
* **Campaign**: If this invoice is a part of on ongoing sales Campaign, it can be linked. To know more, visit the [Campaign page](/docs/v12/user/manual/en/CRM/campaign).
...
<img class="screenshot" alt="POS Invoice" src="{{docs_base_url}}/v12/assets/img/accounts/pos-sales-invoice.png">
