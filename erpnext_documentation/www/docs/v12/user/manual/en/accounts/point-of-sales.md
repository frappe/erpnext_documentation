...
<img class="screenshot" alt="POS Item" src="{{docs_base_url}}/v12/assets/img/accounts/pos-item.png">
...
1. Select row in the cart and click on Delete button in the numeric keypad
    ...
    <img class="screenshot" alt="POS Item" src="{{docs_base_url}}/v12/assets/img/accounts/pos_deleted_item.gif">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/v12/assets/img/accounts/change-amount.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/v12/assets/img/accounts/write-off.png">
...
<img class="screenshot" alt="Change POS Profile" src="{{docs_base_url}}/v12/assets/img/accounts/Change-POS-Profile.png">
...
<img class="screenshot" alt="POS Customer" src="{{docs_base_url}}/v12/assets/img/accounts/pos-customer.gif">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/v12/assets/img/accounts/offline-records.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/v12/assets/img/accounts/pos-email.png">
...
<img class="screenshot" alt="POS Payment" src="{{docs_base_url}}/v12/assets/img/accounts/pos-closing-voucher.png">
