...
<img class="screenshot" alt="Time Log - Drag Calender" src="{{docs_base_url}}/v12/assets/img/project/time_sheet.gif">

###Creando Factura de Venta

* Despues de crear la Hoja de Tiempo/Horario, el botón "Crear Factura" debe aparecer.

<img class="screenshot" alt="Time Log - Drag Calender" src="{{docs_base_url}}/v12/assets/img/project/time_sheet_make_invoice.png">

* Haga clic en ese botón para hacer una factura de venta usando la hoja de tiempo.

<img class="screenshot" alt="Time Log - Drag Calender" src="{{docs_base_url}}/v12/assets/img/project/time_sheet_sales_invoice.png">
