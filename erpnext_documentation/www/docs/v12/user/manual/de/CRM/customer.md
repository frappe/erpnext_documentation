...
<img class="screenshot" alt="Kunde" src="{{docs_base_url}}/v12/assets/img/crm/create-customer.gif">
...
Lesen Sie hierzu auch [Kontakt](/docs/v12/user/manual/de/CRM/contact.html).
