...
<img class="screenshot" alt="E-Mail senden" src="{{docs_base_url}}/v12/assets/img/setup/print/print-format-builder-1.gif">
...
<img class="screenshot" alt="E-Mail senden" src="{{docs_base_url}}/v12/assets/img/setup/print/print-format-builder-2.gif">

### Schritt 3: Ein Feld entfernen

Um ein Feld zu entfernen, legen Sie es einfach zurück in die Seitenleiste.

<img class="screenshot" alt="E-Mail senden" src="{{docs_base_url}}/v12/assets/img/setup/print/print-format-builder-3.gif">
...
<img class="screenshot" alt="E-Mail senden" src="{{docs_base_url}}/v12/assets/img/setup/print/print-format-builder-4.gif">
