...
<img class="screenshot" alt="Druckköpfe" src="{{docs_base_url}}/v12/assets/img/setup/print/print-heading.png">

Hier ist ein Beispiel abgebildet, wie man einen Druckkopf auswechselt:

<img class="screenshot" alt="Druckköpfe" src="{{docs_base_url}}/v12/assets/img/setup/print/print-heading-1.png">
