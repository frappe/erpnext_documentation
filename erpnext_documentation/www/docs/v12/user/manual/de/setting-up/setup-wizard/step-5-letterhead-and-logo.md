...
src="{{docs_base_url}}/v12/assets/img/setup-wizard/step-5.png">
...
Um später einen Briefkopf über das Modul "Einstellungen" auszuwählen, lesen Sie im Bereich [Briefkopf](/docs/v12/user/manual/de/setting-up/print/letter-head.html) weiter.
