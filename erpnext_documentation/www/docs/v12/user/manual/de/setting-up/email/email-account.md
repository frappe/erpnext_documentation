...
<img class="screenshot" alt="Kriterien definieren" src="{{docs_base_url}}/v12/assets/img/setup/email/email-account-list.png">
...
<img class="screenshot" alt="Ausgehende E-Mails" src="{{docs_base_url}}/v12/assets/img/setup/email/email-account-sending.png">
...
<img class="screenshot" alt="Eingehende E-Mails" src="{{docs_base_url}}/v12/assets/img/setup/email/email-account-incoming.png">
...
<img class="screenshot" alt="Eingehende Email" src="{{docs_base_url}}/v12/assets/img/setup/email/email-account-unreplied.png">
