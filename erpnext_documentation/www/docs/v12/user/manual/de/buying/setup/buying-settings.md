...
![Einkaufseinstellungen]({{docs_base_url}}/v12/assets/img/buying/buying-settings.png)
...
[Klicken Sie hier, wenn Sie mehr über Nummernkreise wissen möchten](/docs/v12/user/manual/de/setting-up/settings/naming-series.html)
