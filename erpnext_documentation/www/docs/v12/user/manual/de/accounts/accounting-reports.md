...
<img alt="Hauptbuch" class="screenshot"
    src="{{docs_base_url}}/v12/assets/img/accounts/general-ledger.png">
...
<img alt="Probebilanz" class="screenshot" src="{{docs_base_url}}/v12/assets/img/accounts/reports/trial-balance.png">
...
<img alt="Forderungskonten" class="screenshot" src="{{docs_base_url}}/v12/assets/img/accounts/reports/accounts-receivable.png">
...
<img alt="Übersicht Verkäufe" class="screenshot" src="{{docs_base_url}}/v12/assets/img/accounts/reports/sales-register.png">
