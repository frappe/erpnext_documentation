...
<img class="screenshot" alt="Zahlungen durchführen" src="{{docs_base_url}}/v12/assets/img/accounts/make-payment.png">
...
<img class="screenshot" alt="Zahlungen durchführen" src="{{docs_base_url}}/v12/assets/img/accounts/new-bank-entry.png">
