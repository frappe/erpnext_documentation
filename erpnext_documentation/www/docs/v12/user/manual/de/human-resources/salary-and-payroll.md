...
<img class="screenshot" alt="Gehaltsstruktur" src="{{docs_base_url}}/v12/assets/img/human-resources/salary-structure.png">
...
<img class="screenshot" alt="Lohnzettel" src="{{docs_base_url}}/v12/assets/img/human-resources/salary-slip.png">
...
<img class="screenshot" alt="Gehaltsabrechnung durchführen" src="{{docs_base_url}}/v12/assets/img/human-resources/process-payroll.png">
