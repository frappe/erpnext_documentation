...
Bevor wir uns an das Anpassungswerkzeug heran wagen, klicken Sie [hier](https://frappeframework.com/docs/v12/user/en/understanding-doctypes) um den Aufbau von Formularen in ERPNext zu verstehen. Das soll Ihnen dabei helfen das Anpassungswerkzeug effektiver zu nutzen.
...
![Formular anpassen - Listenansicht](/docs/v12/assets/old_images/erpnext/customize-form-list-view.png)
...
![Formular anpassen - Dokument](/docs/v12/assets/old_images/erpnext/customize-form-document.png)
...
![Formular anpassen - Zwingend erfoderliche Angaben](/docs/v12/assets/old_images/erpnext/customize-form-mandatory.png)
...
![Formular anpassen - Aktualisieren](/docs/v12/assets/old_images/erpnext/customize-form-update.png)
...
<table border="1" width="700px">
  <tbody>
    ...
    <tr>
      <td>Feldtyp</td>
      <td>Klicken Sie <a href="/docs/v12/user/manual/en/customize-erpnext/articles/field-types">hier</a> um mehr über Feldtypen zu erfahren.</td>
    </tr>
    <tr>
      <td>Optionen</td>
