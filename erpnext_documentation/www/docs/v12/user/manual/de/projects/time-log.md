...
<img class="screenshot" alt="Zeitprotokoll" src="{{docs_base_url}}/v12/assets/img/project/time_log.png">
...
<img class="screenshot" alt="Zeitprotokoll - Kalender ansehen" src="{{docs_base_url}}/v12/assets/img/project/time_log_view_calendar.png">

* Um ein Zeitprotokoll für mehrere Tage zu erstellen, klicken Sie und ziehen Sie den Mauszeiger über die Tage.

<img class="screenshot" alt="Zeitprotokoll - Kalender aufziehen" src="{{docs_base_url}}/v12/assets/img/project/time_log_calendar_day.gif">

* Sie können Zeitprotokolle auch aus der Wochen- oder Tagesansicht des Kalender heraus erstellen.

<img class="screenshot" alt="Zeitprotokoll - Kalender aufziehen" src="{{docs_base_url}}/v12/assets/img/project/time_log_calendar_week.gif">
...
* Im Abschnitt Kostenberechnung erstellt das System den Rechungsbetrag über die [Aktivitätskosten](/docs/v12/user/manual/de/projects/activity-cost.html)  basierend auf dem angegebenen Mitarbeiter und der angegebenen Aktivitätsart.
...
<img class="screenshot" alt="Zeitprotokoll - Abrechnung" src="{{docs_base_url}}/v12/assets/img/project/time_log_costing.png">

* Nach dem Übertragen des Zeitprotokolls müssen Sie einen [Zeitprotokollstapel](/docs/v12/user/manual/de/projects/time-log-batch.html) erstellen um mit der Abrechnung fortfahren zu können.
