...
<img alt="Print Format" class="screenshot" src="{{docs_base_url}}/assets/img/customize/standard-desk-page.png">

## Standard Desk Page

Every module in ERPNext has its own Standard Desk Page which is generated with appropriate shortcuts and links.

<img alt="Print Format" class="screenshot" src="{{docs_base_url}}/assets/img/customize/desk-page-list.png">
...
<img alt="Print Format" class="screenshot" src="{{docs_base_url}}/assets/img/customize/customize-desk-page.png">

## Custom Desk Page

You can also create your own Desk Pages by simply creating new Desk Page document.

<img alt="Print Format" class="screenshot" src="{{docs_base_url}}/assets/img/customize/new-desk-page.png">

1. Go to the Desk Page list and click on New.

1. **Name**: The text you enter here will be shown in the sidebar.

1. **Module**: Select the module which the Desk Page will represents.

1. ***Is Standard***: If checked, this Desk Page will be shown in the sidebar otherwise it will be treated as a customized version of other Desk Page.
...
<img alt="Print Format" class="screenshot" src="{{docs_base_url}}/assets/img/customize/desk-page-card.png">
