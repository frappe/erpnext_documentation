...
7. Submit the entry
8. Same will also be visible in TDS payable monthly report

 <img class="screenshot" alt="Tax Withholding Category" src="{{docs_base_url}}/assets/img/accounts/advance-tds-payable-monthly.png">
