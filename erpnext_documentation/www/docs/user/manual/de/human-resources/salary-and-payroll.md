...
<img class="screenshot" alt="Gehaltsstruktur" src="{{docs_base_url}}/assets/img/payroll/salary-structure.png">
...
<img class="screenshot" alt="Lohnzettel" src="{{docs_base_url}}/assets/img/payroll/salary-slip.png">
